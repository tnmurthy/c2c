...
const projects = [
    {
        ...
        icon: ICONS.gear,
        tooltip: 'llm.c',
        content: `<h3>llm.c</h3><p>LLM training in simple, pure C/CUDA. 20k+ GitHub stars.</p><p><strong>Stack:</strong> C, CUDA</p>`
    },
    {
        id: 'nanogpt',
        title: 'nanoGPT',
        icon: ICONS.gear,
        tooltip: 'nanoGPT',
        content: `<h3>nanoGPT</h3><p>The simplest, fastest repository for training/finetuning medium-sized GPTs.</p><p><strong>Stack:</strong> Python, PyTorch</p>`
    },
    {
        id: 'micrograd',
        title: 'micrograd',
        icon: ICONS.gear,
        tooltip: 'micrograd',
        content: `<h3>micrograd</h3><p>A tiny scalar-valued autograd engine and a neural net on top of it.</p><p><strong>Stack:</strong> Python</p>`
    },
    {
        id: 'resume',
        title: 'My Resume',
        ...
        content: `<h3>Andrej Karpathy - Resume</h3>
        <hr>
        <p><strong>Roles:</strong> Python, PyTorch, C</p>
        <hr>
        <p><strong>Summary:</strong> Building a kind of JARVIS. Previously Director of AI at Tesla, Founding member at OpenAI. Expert in Deep Learning, Computer Vision, and LLMs.</p>
        <hr>
        <p><strong>Expertise:</strong></p>
        <ul><li>Python</li><li>PyTorch</li><li>C</li></ul>`
    }
];
...
const aboutMeContent = {
    ...
    title: 'About Me',
    icon: ICONS.computer,
    content: `<h3>Andrej Karpathy</h3>
    <p><strong>Python · PyTorch · C</strong></p>
    <hr>
    <p>Building a kind of JARVIS. Previously Director of AI at Tesla, Founding member at OpenAI. Expert in Deep Learning, Computer Vision, and LLMs.</p>
    <button class="btn-win95" onclick="window.open('https://www.linkedin.com/in/andrej-karpathy/', '_blank')">LinkedIn Profile</button>
    <button class="btn-win95" onclick="window.open('https://github.com/karpathy', '_blank')">GitHub</button>`
};
