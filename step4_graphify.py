...
if existing_graph_path.exists():
    ...
    G = nx.node_link_graph(data, directed=G_new.is_directed())
...
report = generate(G, communities, cohesion, labels, gods, surprises, detection, tokens, 'docs', suggested_questions=questions)
