...
_RESUME = """
Alex Example
Software Engineer | Example City, US
alex@example.test | +1 555 010 0000 | linkedin.com/in/alex-example
...
_IDENTITY = {
    ...
    "website": "https://github.com/alex-example",
